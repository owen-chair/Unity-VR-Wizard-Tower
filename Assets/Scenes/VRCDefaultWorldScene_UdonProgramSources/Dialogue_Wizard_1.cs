...
public class Dialogue_Wizard_1 : CustomDialogue
{
    ...
    {
        {
            ...
            {
                {(DataToken)"sound", (DataToken)"hello" },
                {(DataToken)"text", (DataToken)"Hello."},
                {
        ...
        },
        {
            ...
            {
                {(DataToken)"sound", (DataToken)"iamawizard" },
                {(DataToken)"text", (DataToken)"I am a wizard, my name is Martin."},
                {(DataToken)"options", (DataToken)new DataList
                    {
                        (DataToken)"I have more questions.",
                        (DataToken)"Bye."
                    }
                },
                {(DataToken)"nextNodes", (DataToken)new DataList
                    {
                        (DataToken)1,  // Option 0 leads back to Dialogue 0
        ...
        },
        {
            ...
            {
                {(DataToken)"sound", (DataToken)"thisiswizardtower" },
                {(DataToken)"text", (DataToken)"This is the Grand Wizards' Tower."},
                {(DataToken)"options", (DataToken)new DataList
                    {
                        (DataToken)"I have more questions.",
                        (DataToken)"Bye."
